...
export default function Rightbar({profile}) {
            ...
            <>
             <div className="birthdayContainer">
                    ...
                    <span className='birthdayText'>
                        <b>Juan Lopez</b>  y <b>otros 3 de tus Amigos</b> Cumplen años hoy.
                    </span>
                </div>
    ...
    const ProfileRightbar = () =>{
     ...
     return(
            <>
            <h4 className='rightbarTitle'>Tu Info de Usuario</h4>
            <div className="rightbarInfo">
                ...
                <div className="rightbarInfoItem">
                    ...
                    <span className="rightbarInfoValue">Apure</span>
                </div>
                <div className="rightbarInfoItem">
            ...
            <div className="rightbarFollowings">
                ...
                <div className="rightbarFollowing">
                    ...
                    <span className="rightbarFollowingName">Jackson Senegal</span>
                </div>
